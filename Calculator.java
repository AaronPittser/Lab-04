...
public class Calculator
{
    ...
    public static String parseAndExecute(String input)
    {
        ...
        try {
			...
			str = "Input number cannot be parsed to an int. Please try again.";
		} catch (ArithmeticException e){
			str = "Attempted to divide by 0. Please try again.";
		} catch (CalculatorException e) {
			str = "Calculator Exception, message is: " + e.getMessage();
		}
