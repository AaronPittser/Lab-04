...
public class CalculatorTest {
    ...
    public void calculateTwoTokensTestInvalidCommand() throws AssertException
    {
    	try
        {
            int result = Calculator.calculateTwoTokens(new String[] {"foo", "5"});
            Assert.assertEquals(-5, result);
        }
        catch (Exception e)
        {
    ...
    public void calculateThreeTokensTestValidAdd() throws AssertException
    {
    	try
        {
            int result = Calculator.calculateTwoTokens(new String[] {"3", "+", "5"});
    ...
    public void calculateThreeTokensTestValidSubtract() throws AssertException
    {
    	try
        {
            int result = Calculator.calculateTwoTokens(new String[] {"5", "-", "3"});
    ...
    public void calculateThreeTokensTestValidDivide() throws AssertException
    {
    	try
        {
            int result = Calculator.calculateTwoTokens(new String[] {"6", "/", "2"});
            Assert.assertEquals(3, result);
        }
        catch (Exception e)
        {
    ...
    public void calculateThreeTokensTestInvalidCommand() throws AssertException
    {
    	try
        {
            int result = Calculator.calculateTwoTokens(new String[] {"3", "foo", "5"});
            Assert.assertEquals(8, result);
        }
        catch (Exception e)
        {
    ...
    public void executeTestValidThreeTokens() throws AssertException
    {
    	try
        {
            int result = Calculator.execute(new String[] {"3", "+", "5"});
            Assert.assertEquals(8, result);
        }
        catch (Exception e)
        {
    ...
    public void executeTestInvalidTokenLength() throws AssertException
    {
    	...
    	try
        {
            int result = Calculator.execute(new String[] {"3", "+", "5", "foo"});
            Assert.assertEquals(8, result);
        }
        catch (Exception e)
        {
    ...
    {
    	String result = Calculator.parseAndExecute("6 / foo");
    ...
    {
    	String result = Calculator.parseAndExecute("6 / 3 2");
